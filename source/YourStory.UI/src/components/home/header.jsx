    ...
    return (
        <div>
            <div className='header'>
                ...
                <a className='item d-none d-md-block' href='/share'><label className='label'>Share</label></a>
                <a className='item' href='/explore'><label className='label'>Explore</label></a>
                <a className='item d-none d-md-block' href='/grasp'><label className='label'>Grasp</label></a>
            </div>
        </div>
